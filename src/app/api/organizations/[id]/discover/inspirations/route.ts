...
/**
 * GET, POST /api/organizations/[id]/discover/inspirations
 *
 * Switched off: this endpoint saved warehouse post ids (discover_inspirations, dropped). The KOL product reads the KOL database
...
async function unavailable(params: Params['params']) {
  ...
  return featureUnavailable('Inspirations')
}
