...
/**
 * GET /api/organizations/[id]/discover/content
 *
 * Switched off: this endpoint lists brand/competitor posts from the analytics warehouse. The KOL product reads the KOL database
...
async function unavailable(params: Params['params']) {
  ...
  return featureUnavailable('Content discovery')
}
