...
/**
 * PATCH /api/organizations/[id]/discover/orders/[orderId]/items/[itemId]
 *
 * Switched off: this endpoint discover_order_items on the analytics warehouse (dropped). The KOL product reads the KOL database
