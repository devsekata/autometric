...
.item:hover{border-color:#3d7e96;background:#f0f7fa}
...
.spinner{width:28px;height:28px;border:2.5px solid #e5e7eb;border-top-color:#3d7e96;border-radius:50%;animation:sp 0.7s linear infinite}
