    ...
    <div>
      ...
      <div className="flex items-center justify-end gap-2.5 mb-6">
        <button
          ...
          style={PJ}
          className="flex items-center gap-2 bg-white hover:bg-[#EAF2F6] disabled:opacity-60 text-[#327488] text-[13px] font-bold px-5 py-2.5 rounded-xl border border-[#327488]/30 hover:border-[#327488] transition-colors"
        >
        ...
        <div className="relative">
          <button
            ...
            disabled={isExporting}
            style={PJ}
            className="flex items-center gap-2 bg-[#327488] hover:bg-[#285D6E] disabled:opacity-60 text-white text-[13px] font-bold pl-5 pr-4 py-2.5 rounded-xl shadow-[0_4px_14px_rgba(30,79,73,0.30)] transition-colors"
          >
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl border border-[#e5e7eb] shadow-[0_12px_34px_rgba(15,23,42,0.14)] overflow-hidden z-20 py-1">
                <button
                  ...
                  style={PJ}
                  className="w-full flex items-start gap-3 px-4 py-3 hover:bg-[#EAF2F6] transition-colors text-left"
                >
                  <span className="material-symbols-outlined text-[20px] text-[#327488] mt-0.5">download</span>
                  <span>
                ...
                <button
                  ...
                  className="w-full flex items-start gap-3 px-4 py-3 hover:bg-[#EAF2F6] transition-colors text-left"
                >
                  <span className="material-symbols-outlined text-[20px] text-[#327488] mt-0.5">cloud_upload</span>
                  <span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div
          onClick={onEditCover}
          className="group cursor-pointer bg-white rounded-2xl border border-[#e5e7eb] overflow-hidden hover:shadow-[0_8px_26px_rgba(15,23,42,0.10)] hover:border-[#327488] hover:-translate-y-0.5 transition-all"
        >
          <div className="aspect-video relative border-b border-[#f1f3f5] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
              <span style={PJ} className="flex items-center gap-1.5 bg-white px-3.5 py-2 rounded-lg text-[12px] font-bold text-[#327488] shadow-sm">
          ...
          <div className="px-4 h-14 flex items-center justify-between">
            ...
            <span style={PJ} className="text-[10px] font-bold uppercase tracking-wide text-[#327488] bg-[#E6E7F3] px-2 py-0.5 rounded-full">Cover</span>
          </div>
        </div>
        ...
        {slides.map((s, i) => (
          <div
            key={s.id}
            onClick={() => onOpen(s.id)}
            className="group cursor-pointer bg-white rounded-2xl border border-[#e5e7eb] overflow-hidden hover:shadow-[0_8px_26px_rgba(15,23,42,0.10)] hover:border-[#285D6E] hover:-translate-y-0.5 transition-all"
          >
            <div className="aspect-video relative border-b border-[#f1f3f5] overflow-hidden">
              <SlidePreview slide={s} colors={colors} chrome={chromeFor(i)} />
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
                <span style={PJ} className="flex items-center gap-1.5 bg-white px-3.5 py-2 rounded-lg text-[12px] font-bold text-[#285D6E] shadow-sm">
            ...
            <div className="px-4 h-14 flex items-center justify-between gap-2">
              {editingId === s.id ? (
                <input
                  ...
                  style={PJ}
                  className="flex-1 text-[13.5px] font-bold text-[#0f172a] border-b-2 border-[#285D6E] outline-none bg-transparent"
                />
              ) : (
                <>
                  ...
                  <div className="flex items-center gap-0.5 flex-shrink-0">
                    <button
                      ...
                      title="Rename"
                      className="opacity-0 group-hover:opacity-100 w-7 h-7 flex items-center justify-center rounded-md text-[#9ca3af] hover:text-[#285D6E] hover:bg-[#f0f7fa] transition"
                    >
        ...
        <button
          onClick={onAdd}
          className="aspect-[16/10] rounded-2xl border-2 border-dashed border-[#d1d5db] hover:border-[#327488] hover:bg-[#EAF2F6] transition-all flex flex-col items-center justify-center gap-3 group"
        >
          <span className="w-12 h-12 rounded-full bg-[#f3f4f6] group-hover:bg-[#dcebe6] flex items-center justify-center text-[#9ca3af] group-hover:text-[#327488] transition-colors">
            <span className="material-symbols-outlined text-[26px]">add</span>
          </span>
          <span style={PJ} className="text-[13px] font-semibold text-[#6b7280] group-hover:text-[#327488]">Add slide</span>
        </button>
      </div>
    </div>
  )
