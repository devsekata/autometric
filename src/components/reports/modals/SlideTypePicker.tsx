          ...
          <div className="p-6 grid grid-cols-2 gap-3">
            {CHANNELS.map(c => (
              <button
                ...
                className="group flex items-center gap-3.5 p-4 rounded-xl border border-[#e5e7eb] hover:border-[#327488] hover:bg-[#EAF2F6] hover:shadow-sm cursor-pointer text-left transition-all"
              >
                <span className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 bg-[#f1f5f9] group-hover:bg-white transition-colors">
                  {c.logo ? (
                    ...
                    <span className="material-symbols-outlined text-[22px] text-[#327488]">{c.icon}</span>
                  )}
                </span>
            ...
            {templates.map(t => (
              <button
                ...
                className={`group flex items-center gap-3.5 p-4 rounded-xl border text-left transition-all ${
                  t.enabled
                    ? 'border-[#e5e7eb] hover:border-[#327488] hover:bg-[#EAF2F6] hover:shadow-sm cursor-pointer'
                    : 'border-[#eef0f2] bg-[#fafbfb] opacity-70 cursor-not-allowed'
                }`}
              >
                <span
                  className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${
                    t.enabled ? 'bg-[#E6E7F3] text-[#327488] group-hover:bg-[#327488] group-hover:text-white' : 'bg-[#f1f3f5] text-[#cbd5e1]'
                  } transition-colors`}
                >
