...
export const PALETTE = ['#285D6E', '#e0a458', '#5fa783', '#d97a7a', '#8b7fc7', '#5b94b8']
...
export const BRANDS: DashBrand[] = [
  { id: 'b1', name: 'Aurora Coffee',  handle: '@auroracoffee',  initials: 'AC', color: '#327488', followers: 128400, platforms: ['instagram', 'facebook', 'tiktok'] },
  { id: 'b2', name: 'Nimbus Apparel', handle: '@nimbus.co',     initials: 'NA', color: '#285D6E', followers: 96200,  platforms: ['instagram', 'tiktok'] },
...
export const TOP_CONTRIBUTORS: Contributor[] = [
  { username: 'nayya070805',     initials: 'NA', tier: 'Super Fan',         comments: 42, relevancy: 94, color: '#285D6E', quote: 'Udah sama Manda aja, udah dicintai secara ugal ugalan…' },
...
export const CONTENT_ATTRIBUTES: ContentAttribute[] = [
  ...
  { label: 'Event',         count: 11,  er: 7.4, color: '#285D6E' },
...
export const STORY_FUNNEL: { label: string; value: number; color: string }[] = [
  ...
  { label: 'Taps Back', value: 118000, color: '#285D6E' },
...
export const WATCH_BY_PILLAR: { label: string; value: number; color: string }[] = [
  ...
  { label: 'Comedy Skit',   value: 10.8, color: '#285D6E' },
]
...
export const PILLAR_COLORS = ['#6c4cd6', '#d23f6f', '#3d7eea', '#5fa783', '#e0a458', '#8b5cf6', '#285D6E', '#d97a7a']
