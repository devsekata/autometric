            ...
            return (
              <button key={b.id}
                ...
                <div className="flex-1 min-w-0">
                  <span style={PJ} className={`block text-[13px] font-bold truncate ${active ? 'text-[#327488]' : 'text-[#111827]'}`}>{b.name}</span>
                ...
                {active && <span className="material-symbols-outlined text-[18px] text-[#285D6E] flex-shrink-0">check</span>}
              </button>
            )
          })}
        </div>
