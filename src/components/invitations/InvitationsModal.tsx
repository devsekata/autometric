                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      disabled={isBusy}
                      style={PJB}
                      className="h-8 px-3.5 text-[12.5px] font-semibold bg-[#3d7e96] hover:bg-[#2d6e85] text-white rounded-lg transition-colors disabled:opacity-40 flex items-center gap-1.5"
                    >
                      {isBusy
