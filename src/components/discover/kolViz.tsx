 ...
 *
 * Worth stating plainly, because the risk did not go away with the badge: the
 * modelled figures are still on screen, now without anything saying so. Reach,
 * impressions, shares, saves, CPE, growth, audience quality, authenticity, and
 * the whole of Audience / Campaign History / Brand Fit / AI Insights are
 * once generated by `@/lib/discover/kolSample` (deleted in Phase 4D) and read
 * exactly like the measured
 * ones beside them.
 */
