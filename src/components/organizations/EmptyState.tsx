...
export default function EmptyState({ onNew }: Props) {
  return (
    <div className="flex flex-col items-center justify-center py-28 px-8">
      <div className="w-9 h-9 rounded-lg bg-[#EDF4F7] flex items-center justify-center mb-4">
        <span className="material-symbols-outlined text-[20px] text-[#285D6E]">corporate_fare</span>
      </div>
      ...
      <button
        onClick={onNew}
        className="h-9 px-4 bg-[#285D6E] hover:bg-[#1E4A58] text-white text-[13px] font-medium rounded-md transition-colors"
      >
        New Organization
      </button>
    </div>
